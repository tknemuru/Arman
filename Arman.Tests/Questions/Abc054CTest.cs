...
{
    [TestClass]
    public class Abc054CTest : BaseUnitTest
    {
        [TestMethod]
        public void 基本ケース()
        {
        ...
        private void Test()
        {
            var actual = Abc054C.Resolve(new string[]
            {
                "cX",
                "cX",
                "cX",
            ...
            actual = Abc054C.Resolve(new string[]
            {
                "cX",
                "cX",
                "cX",
        ...
        private void TestFromFile()
        {
            ...
            var actual = Abc054C.Resolve(input);
            Assert.AreEqual(2, actual);

            input = this.ReadResource(1, 2, ResourceType.In).ToArray();
            actual = Abc054C.Resolve(input);
