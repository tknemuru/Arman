...
{
    [TestClass]
    public class Abc083Arc088ATest : BaseUnitTest
    {
        [TestMethod]
        public void 基本ケース()
        {
        ...
        private void Test()
        {
            var actual = Abc083Arc088A.Resolve(new string[]
            {
                "aX",
                "aX",
                "aX",
            ...
            actual = Abc083Arc088A.Resolve(new string[]
            {
                "aX",
                "aX",
                "aX",
        ...
        private void TestFromFile()
        {
            ...
            var actual = Abc083Arc088A.Resolve(input);
            Assert.AreEqual(3, actual);

            input = this.ReadResource(1, 2, ResourceType.In).ToArray();
            actual = Abc083Arc088A.Resolve(input);
            Assert.AreEqual(3, actual);
